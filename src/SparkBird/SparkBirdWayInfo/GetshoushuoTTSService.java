...
public class GetshoushuoTTSService extends Service {
	// 标题
	...
	private final static String updateFileFromServer = "http://www.dalian1008.com/files/shoushuoTTS.apk";
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		updateNotification.tickerText = "shoushuoTTS开始下载";

		// 下载进度以百分比显示
		updateNotification.setLatestEventInfo(this, "shoushuoTTS下载", "0%",
				updatePendingIntent);
	...
	private Handler updateHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case DOWNLOAD_COMPLETE:
				...
				updatePendingIntent = PendingIntent.getActivity(GetshoushuoTTSService.this, 0, installIntent, 0);
				updateNotification.defaults = Notification.DEFAULT_SOUND;//铃声提醒
			...
			case DOWNLOAD_FAIL:
				// 下载失败
				updateNotification.setLatestEventInfo(GetshoushuoTTSService.this,
						"shoushuoTTS", "下载完成,点击安装。", updatePendingIntent);
				updateNotificationManager.notify(0, updateNotification);
			default:
				stopService(updateIntent);
			}
...
/*				// 下载进度以百分比显示
				...
				// 下载进度以进度条显示
				updateNotification.setLatestEventInfo(GetshoushuoTTSService.this,
						"shoushuoTTS正在下载", (int) totalSize * 100 / updateTotalSize
								+ "%", updatePendingIntent);
