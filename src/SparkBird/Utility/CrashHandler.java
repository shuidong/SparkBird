...
/*				Toast.makeText(mContext, "程序出错啦:" + msg, Toast.LENGTH_LONG)
		...
		// 收集设备信息
		WriteLogSendToServer.collectCrashDeviceInfo(mContext);
		// 保存错误报告文件
		WriteLogSendToServer.saveCrashInfoToFile(mContext, ex);
		// 发送错误报告到服务器
		WriteLogSendToServer.sendCrashReportsToServer(mContext);
		return true;
	}
}
